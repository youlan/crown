...
public class RequestPointResourceIT {
    ...
    public void searchRequestPoint() throws Exception {
        // Initialize the database
        requestPointRepository.save(requestPoint);
        when(mockRequestPointSearchRepository.search(queryStringQuery("id:" + requestPoint.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(requestPoint), PageRequest.of(0, 1), 1));
